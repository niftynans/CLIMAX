...
def inverse_hvp_lissa(x_train,y_train,y_pred,v,
    ...
    for r in range(repeat):
        ...
        #print("Repeat at {} times: norm is {:.2f}".format(r, np.linalg.norm(current_estimate)))
...
def main():
    ...
    #print("Attribute predicted_loss_diffs, mean {}, max {}, min {}".format(predicted_loss_diffs.mean(), predicted_loss_diffs.max(), predicted_loss_diffs.min()))
